CREATE PROC [FOND_ID].[USP_LOAD_ETL1_IFRS17_L2_CODE_GHO_ROLLUP_ENTITY] @BATCHDATESTR [NVARCHAR](10),@JOBNAMESTR [NVARCHAR](2000),@ENTITY [NVARCHAR](2000),@P_PRD_ID [integer] AS
...
SET @v_SQL_1='TRUNCATE TABLE ABST_ID'+@ENTITY+'.ABST_L2_CODE_GHO_ROLLUP;'

EXEC (@v_SQL_1)

SET @v_SQL_2='
INSERT INTO ABST_ID'+@ENTITY+'.ABST_L2_CODE_GHO_ROLLUP
(
	ENTITY_ID,
	LBU_PARAMETER,
	LBU_PARAMETER_CD,
...
FROM (
		...
		SELECT CASE 
			...
			ELSE ''ERROR'' END FLAG
			, ABST_L2_CODE_GHO_ROLLUP.* FROM ABST_ID.ABST_L2_CODE_GHO_ROLLUP
		) A
		WHERE FLAG='''+@ENTITY+'''
		UNION ALL
		SELECT '''+@ENTITY+''' AS ENTITY_ID,
