CREATE PROC [FOND_ID].[USP_LOAD_ETL1_IFRS17_FNC_MONTHLY_ICG_MPFILES_PROPHETU_PUL] @BATCHDATESTR [NVARCHAR](10),@JOBNAMESTR [NVARCHAR](2000),@PRD_ID [INTEGER] AS
...
BEGIN TRY
	...
	--set variable
	SET @V_FUNCTION_NAME = 'FOND_ID.USP_LOAD_ETL1_IFRS17_FNC_MONTHLY_ICG_MPFILES_PROPHETU_PUL';
	SET @V_SEQNO = 1;
	...
	IF OBJECT_ID('tempdb.dbo.#TMP_IFRS17_ICG_STORES_PROPHETU_PUL_TMP_1', 'U') IS NOT NULL DROP TABLE tempdb.dbo.#TMP_IFRS17_ICG_STORES_PROPHETU_PUL_TMP_1;
	IF OBJECT_ID('tempdb.dbo.#TMP_IFRS17_ICG_STORES_PROPHETU_PUL_TMP_2', 'U') IS NOT NULL DROP TABLE tempdb.dbo.#TMP_IFRS17_ICG_STORES_PROPHETU_PUL_TMP_2;
	IF OBJECT_ID('tempdb.dbo.#TMP_IFRS17_ICG_STORES_PROPHETU_PUL_TMP_INVALID', 'U') IS NOT NULL DROP TABLE tempdb.dbo.#TMP_IFRS17_ICG_STORES_PROPHETU_PUL_TMP_INVALID;

	--drop permanent object if exists
	IF OBJECT_ID('FOND_ID.FOND_IFRS17_ICG_STORES_PROPHETU_PUL_DUP','U') IS NOT NULL DROP TABLE FOND_ID.FOND_IFRS17_ICG_STORES_PROPHETU_PUL_DUP;
	IF OBJECT_ID('STAG_ID.TMP_IFRS17_IPRVPF_BEN_EXP','U') IS NOT NULL DROP TABLE STAG_ID.TMP_IFRS17_IPRVPF_BEN_EXP;
	IF OBJECT_ID('STAG_ID.TMP_IFRS17_ICG_STORES_PROPHETU_PUL','U') IS NOT NULL DROP TABLE STAG_ID.TMP_IFRS17_ICG_STORES_PROPHETU_PUL;
	IF OBJECT_ID('FOND_ID.FOND_IFRS17_ICG_STORES_PROPHETU_PUL_INVALID','U') IS NOT NULL DROP TABLE FOND_ID.FOND_IFRS17_ICG_STORES_PROPHETU_PUL_INVALID;
	--IF OBJECT_ID('FOND_ID.FOND_IFRS17_MPFILES_PROPHETU_PUL','U') IS NOT NULL DROP TABLE FOND_ID.FOND_IFRS17_MPFILES_PROPHETU_PUL;
	TRUNCATE TABLE FOND_ID.FOND_IFRS17_MPFILES_PROPHETU_PUL;
	--TRUNCATE TABLE FOND_ID.FOND_IFRS17_ICG_STORES_PROPHETU_PUL_INVALID;
	...
	CREATE TABLE FOND_ID.FOND_IFRS17_ICG_STORES_PROPHETU_PUL_DUP
	WITH
	(
	...
	FROM STAG_ID.STAG_LIFEASIA_IPRVPF
	WHERE CHDRNUM IN (SELECT CHDRNUM FROM STAG_ID.STAG_LIFEASIA_IPRVPF WHERE NULLIF(TRIM(CHDRNUM), '') IS NOT NULL GROUP BY CHDRNUM HAVING COUNT(*) > 1);

	-----------------------------------------------------------------------
	--- CREATE TABLE TO STORE INFORMATION OF BEN_EXP_DATE PER POLICY NUMBER
	-----------------------------------------------------------------------
	SET @V_SEQNO = @V_SEQNO + 1;
	SET @V_START = CURRENT_TIMESTAMP;
	SET @V_DESCRIPTION = CONCAT('CREATE TABLE TO STORE INFORMATION OF BEN_EXP_DATE PER POLICY NUMBER : ', @V_START);

	INSERT INTO STAG_ID.STAG_IFRS17_PROC_LOG(PROC_DATE, FUNC_NAME, SEQNO, "DESCRIPTION")
	VALUES (@V_START, @V_FUNCTION_NAME, @V_SEQNO, @V_DESCRIPTION);

	CREATE TABLE STAG_ID.TMP_IFRS17_IPRVPF_BEN_EXP
	WITH
	(
	...
	AS
	SELECT
      NULLIF(TRIM(IPRVPF.CHDRNUM), '') AS POLICY_NO,
	  CONVERT(DATE, CONVERT(CHAR(10), COVRPF.RISK_CESS_DATE)) AS BEN_EXP_DATE,
	  @BATCH_MASTER_ID AS BATCH_MASTER_ID,
      @BATCH_RUN_ID AS BATCH_RUN_ID,
      @JOB_MASTER_ID AS JOB_MASTER_ID,
      @JOB_RUN_ID AS JOB_RUN_ID,
	...
	FROM STAG_ID.STAG_LIFEASIA_IPRVPF IPRVPF
	
	LEFT JOIN FOND_ID.FOND_IFRS17_ICG_STORES_PROPHETU_PUL_DUP AS IPRVPF_DUP
	ON NULLIF(TRIM(IPRVPF.CHDRNUM), '') = NULLIF(TRIM(IPRVPF_DUP.CHDRNUM), '')
	AND IPRVPF.CNTTYPE = IPRVPF_DUP.CNTTYPE
	
	JOIN STAG_ID.STAG_LIFEASIA_COVRPF AS COVRPF
	ON NULLIF(TRIM(IPRVPF.CHDRNUM), '') = NULLIF(TRIM(COVRPF.CHDRNUM), '')
	AND IPRVPF.CNTTYPE = SUBSTRING(COVRPF.CRTABLE, 1,3)
	
	WHERE COVRPF.VALIDFLAG = 1
	AND NULLIF(TRIM(IPRVPF_DUP.CHDRNUM), '') IS NULL;
	...
	-----------------------------------------------
	--create temp table tempdb.dbo.#TMP_IFRS17_ICG_STORES_PROPHETU_PUL_TMP_1
	-----------------------------------------------
	CREATE TABLE tempdb.dbo.#TMP_IFRS17_ICG_STORES_PROPHETU_PUL_TMP_1
	WITH
	(
	  DISTRIBUTION = HASH(POLICY_NO),
	  HEAP
	...
	SELECT
	  ...
	  NULLIF(TRIM(IPRVPF.CHDRNUM), '') AS POLICY_NO,
	  IPRVPF.CNTTYPE AS PRODUCT_CD,
	  (NULLIF(TRIM(IPRVPF.CHDRNUM), '') + '-' +
	    FORMAT((CASE
		WHEN IPRVPF.HOISSDTE = 99999999 THEN NULL
        WHEN ICG_STORES.POLICY_NO IS NULL THEN CONVERT(DATE, CONVERT(CHAR(10), CONVERT(INT, IPRVPF.HOISSDTE)))
		WHEN (CB_MAP.BOUND_BY_REPRICE = 'Y' AND (DATEADD(DAY, -1, CONVERT(DATE, CONVERT(CHAR(10), CONVERT(INT, IPRVPF.PTDATE)))) > ICG_STORES.CB_END_DT)) OR (CB_MAP.BOUND_BY_TERMINATION_PROVISION = 'Y' AND @V_START_DATE > ICG_STORES.CB_END_DT) THEN DATEADD(DAY, 1, ICG_STORES.CB_END_DT)
      ...
      CASE
	    WHEN IPRVPF.HOISSDTE = 99999999 THEN NULL
         WHEN ICG_STORES.POLICY_NO IS NULL THEN DATEPART(YEAR, (CONVERT(DATE, CONVERT(CHAR(10), CONVERT(INT, IPRVPF.HOISSDTE)))))
         WHEN (CB_MAP.BOUND_BY_REPRICE = 'Y' AND (DATEADD(DAY, -1, CONVERT(DATE, CONVERT(CHAR(10), CONVERT(INT, IPRVPF.PTDATE)))) > ICG_STORES.CB_END_DT)) OR (CB_MAP.BOUND_BY_TERMINATION_PROVISION = 'Y' AND @V_START_DATE > ICG_STORES.CB_END_DT) THEN DATEPART(YEAR,(DATEADD(DAY, 1, ICG_STORES.CB_END_DT)))
	  ...
	  CASE
			WHEN IPRVPF.HOISSDTE = 99999999 THEN NULL
            WHEN ICG_STORES.POLICY_NO IS NULL THEN  DATEPART(MONTH, (CONVERT(DATE, CONVERT(CHAR(10), CONVERT(INT, IPRVPF.HOISSDTE)))))
			WHEN (CB_MAP.BOUND_BY_REPRICE = 'Y' AND (DATEADD(DAY, -1, CONVERT(DATE, CONVERT(CHAR(10), CONVERT(INT, IPRVPF.PTDATE)))) > ICG_STORES.CB_END_DT)) OR (CB_MAP.BOUND_BY_TERMINATION_PROVISION = 'Y' AND @V_START_DATE > ICG_STORES.CB_END_DT) THEN  DATEPART(MONTH, (DATEADD(DAY, 1, ICG_STORES.CB_END_DT)))
         ELSE ICG_STORES.ENTRY_MONTH
      END	AS ENTRY_MONTH,
	  CASE
	    WHEN ICG_STORES.POLICY_NO IS NULL AND IPRVPF.CRRCD > IPRVPF.HOISSDTE THEN CONVERT(DATE, CONVERT(CHAR(10), CONVERT(INT, IPRVPF.HOISSDTE)))
        WHEN ICG_STORES.POLICY_NO IS NULL THEN CONVERT(DATE, CONVERT(CHAR(10), CONVERT(INT, IPRVPF.CRRCD)))
        WHEN (CB_MAP.BOUND_BY_REPRICE = 'Y' AND (DATEADD(DAY, -1, CONVERT(DATE, CONVERT(CHAR(10), CONVERT(INT, IPRVPF.PTDATE)))) > ICG_STORES.CB_END_DT)) OR (CB_MAP.BOUND_BY_TERMINATION_PROVISION = 'Y' AND @V_START_DATE > ICG_STORES.CB_END_DT) THEN DATEADD(DAY, 1, ICG_STORES.CB_END_DT)
		ELSE ICG_STORES.CB_START_DT
      END AS CB_START_DT,
	  CASE
	  ...
	  IPRVPF_BEN_EXP.BEN_EXP_DATE,
	  IPRVPF.CNTCURR AS CCY_CD,
      IPRVPF.STATCODE AS STATUS_SOURCE,
	  CONVERT(DATE, CONVERT(CHAR(10), CONVERT(INT, IPRVPF.PTDATE))) AS CURR_PTDATE,
	...
	LEFT JOIN STAG_ID.TMP_IFRS17_IPRVPF_BEN_EXP AS IPRVPF_BEN_EXP
	ON NULLIF(TRIM(IPRVPF.CHDRNUM), '') = IPRVPF_BEN_EXP.POLICY_NO
	
	LEFT JOIN FOND_ID.FOND_IFRS17_ICG_STORES_PROPHETU_PUL_DUP IPRVPF_DUP
	ON NULLIF(TRIM(IPRVPF.CHDRNUM), '') = NULLIF(TRIM(IPRVPF_DUP.CHDRNUM), '')
	AND IPRVPF.CNTTYPE = IPRVPF_DUP.CNTTYPE
	
	WHERE NULLIF(TRIM(IPRVPF_DUP.CHDRNUM), '') IS NULL;

	-----------------------------------------------
	--create temp table tempdb.dbo.#TMP_IFRS17_ICG_STORES_PROPHETU_PUL_TMP_2
	-----------------------------------------------
	CREATE TABLE tempdb.dbo.#TMP_IFRS17_ICG_STORES_PROPHETU_PUL_TMP_2
	WITH
	(
	  DISTRIBUTION = HASH(POLICY_NO),
	  HEAP
	...
	FROM tempdb.dbo.#TMP_IFRS17_ICG_STORES_PROPHETU_PUL_TMP_1;

	-------------------------------------------------
	--store the result to ICG_STORES_PROPHETU_PUL_TMP
	-------------------------------------------------
	CREATE TABLE STAG_ID.TMP_IFRS17_ICG_STORES_PROPHETU_PUL
	WITH
	(
	  DISTRIBUTION = HASH(POLICY_NO),
	  CLUSTERED INDEX(POLICY_NO)
	...
	SELECT * , 
		...
		FROM tempdb.dbo.#TMP_IFRS17_ICG_STORES_PROPHETU_PUL_TMP_2 
	) A;

	-----------------------------------------------
	--create temp table tempdb.dbo.#TMP_IFRS17_ICG_STORES_PROPHETU_PUL_TMP_INVALID
	-----------------------------------------------
	SET @V_SEQNO = @V_SEQNO + 1;
	SET @V_START = CURRENT_TIMESTAMP;
	SET @V_DESCRIPTION = CONCAT('create temp table tempdb.dbo.#TMP_IFRS17_ICG_STORES_PROPHETU_PUL_TMP_INVALID : ', @V_START);

	INSERT INTO STAG_ID.STAG_IFRS17_PROC_LOG(PROC_DATE, FUNC_NAME, SEQNO, "DESCRIPTION")
	VALUES (@V_START, @V_FUNCTION_NAME, @V_SEQNO, @V_DESCRIPTION);

	CREATE TABLE tempdb.dbo.#TMP_IFRS17_ICG_STORES_PROPHETU_PUL_TMP_INVALID
	WITH
	(
	  DISTRIBUTION = HASH(POLICY_NO),
	  HEAP
	...
	FROM STAG_ID.TMP_IFRS17_ICG_STORES_PROPHETU_PUL
	...
	---------------------------------------------
	--- CREATE TABLE FOND_ID.FOND_IFRS17_ICG_STORES_PROPHETU_PUL_INVALID
	---------------------------------------------
	SET @V_SEQNO = @V_SEQNO + 1;
	SET @V_START = CURRENT_TIMESTAMP;
	SET @V_DESCRIPTION = CONCAT('CREATE TABLE FOND_ID.FOND_IFRS17_ICG_STORES_PROPHETU_PUL_INVALID : ', @V_START);
    ...
    FROM STAG_ID.TMP_IFRS17_ICG_STORES_PROPHETU_PUL AS ICG_STORES_TMP
	...
	SET
	  INFORCE_FLAG = (CASE
	                    WHEN IFRS17_ICG_STORES_PROPHETU_PUL_TMP.STATUS_SOURCE = ICG_STORES.STATUS_SOURCE AND ICG_STORES.STATUS_SOURCE = 'IF' AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.CB_END_DT <> ICG_STORES.CB_END_DT AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.FLAG_INSERT_UPDATE = 'INSERT' THEN 'N'
	                    WHEN IFRS17_ICG_STORES_PROPHETU_PUL_TMP.FLAG_INSERT_UPDATE = 'INSERT' THEN 'N'
                        ELSE IFRS17_ICG_STORES_PROPHETU_PUL_TMP.INFORCE_FLAG
                      END),
	  STATUS_SOURCE = (CASE
	                     WHEN IFRS17_ICG_STORES_PROPHETU_PUL_TMP.FLAG_INSERT_UPDATE = 'INSERT' THEN ICG_STORES.STATUS_SOURCE
	                     ELSE IFRS17_ICG_STORES_PROPHETU_PUL_TMP.STATUS_SOURCE
	                   END),
	...
	JOIN STAG_ID.TMP_IFRS17_ICG_STORES_PROPHETU_PUL AS IFRS17_ICG_STORES_PROPHETU_PUL_TMP
	ON IFRS17_ICG_STORES_PROPHETU_PUL_TMP.POLICY_NO = LATEST_ICGS.POLICY_NO
	AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.FLAG_INSERT_UPDATE IN('INSERT', 'UPDATE')

	WHERE UPPER(TRIM(ICG_STORES.SUBSYSTEM)) = 'PROPHETU_PUL'
	AND ICG_STORES.PRODUCT_CD = ICG_STORES.BENEFIT_CD
	AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.POLICY_NO IS NOT NULL
	AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.PRODUCT_CD IS NOT NULL
    AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.CONTRACT_ID IS NOT NULL
    AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.PORTFOLIO_GROUP IS NOT NULL
    AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.COHORT_YEAR IS NOT NULL
    AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.SET_OF_CONTRACT IS NOT NULL
    AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.INSURANCE_CONTRACT_GROUP_ID IS NOT NULL
    AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.ICG_ID_PROPHET IS NOT NULL
    AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.ENTRY_MONTH IS NOT NULL
    AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.CB_START_DT IS NOT NULL
    AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.CB_END_DT IS NOT NULL
    AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.MEASUREMENT_MODEL IS NOT NULL
    AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.INFORCE_FLAG IS NOT NULL
    AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.COVERAGE_LEVEL_END_DATE IS NOT NULL
    AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.CCY_CD IS NOT NULL
    AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.STATUS_SOURCE IS NOT NULL
    AND IFRS17_ICG_STORES_PROPHETU_PUL_TMP.BEN_EXP_DATE IS NOT NULL
	AND (IFRS17_ICG_STORES_PROPHETU_PUL_TMP.CB_START_DT <= IFRS17_ICG_STORES_PROPHETU_PUL_TMP.BEN_EXP_DATE OR IFRS17_ICG_STORES_PROPHETU_PUL_TMP.STATUS_SOURCE <> 'IF');
	...
	-------------------------------------
	--- INSERT INTO MPFILES PROPHETU_PUL
	-------------------------------------
	SET @V_SEQNO = @V_SEQNO + 1;
	SET @V_START = CURRENT_TIMESTAMP;
	SET @V_DESCRIPTION = CONCAT('INSERT INTO MPFILES PROPHETU_PUL : ', @V_START);

	INSERT INTO STAG_ID.STAG_IFRS17_PROC_LOG(PROC_DATE, FUNC_NAME, SEQNO, "DESCRIPTION")
	VALUES (@V_START, @V_FUNCTION_NAME, @V_SEQNO, @V_DESCRIPTION);

	INSERT INTO FOND_ID.FOND_IFRS17_MPFILES_PROPHETU_PUL
	SELECT
      IPRVPF.SLSCNL,
      NULLIF(TRIM(IPRVPF.CHDRNUM), '') AS CHDRNUM,
      IPRVPF.CNTCURR,
      IPRVPF.STATCODE,
      IPRVPF.CNTTYPE,
      IPRVPF.ANBCCD,
      ...
      CASE WHEN DATEPART(YEAR, @V_START_DATE) = ICG_STORES_VALID.COHORT_YEAR THEN (ICG_STORES_VALID.INSURANCE_CONTRACT_GROUP_ID + '_' + UPPER(UPPER(ICG_STORES_VALID.ENTRY_MONTH_MMM))) END AS REL_INSURANCE_CONTRACT_GROUP_ID,
	  @BATCH_MASTER_ID AS BATCH_MASTER_ID,
      @BATCH_RUN_ID AS BATCH_RUN_ID,
      @JOB_MASTER_ID AS JOB_MASTER_ID,
      @JOB_RUN_ID AS JOB_RUN_ID,
    ...
    ON NULLIF(TRIM(IPRVPF.CHDRNUM), '') = ICG_STORES_VALID.POLICY_NO
    AND ICG_STORES_VALID.ROWNUM_POLICY_NO = 1
...
--    AND UPPER(TRIM(PORTFOLIO_MAP."SYSTEM")) = 'LIFE ASIA'
	...
	LEFT JOIN STAG_ID.STAG_CONFIG_IFRS17_ICG_CONFIG AS ICG_CONFIG
    ON (CASE WHEN (ICG_STORES_VALID.COHORT_YEAR) <'2006' THEN '2006' ELSE (ICG_STORES_VALID.COHORT_YEAR) END) = ICG_CONFIG.COHORT_YEAR
