CREATE PROC [FOND_ID].[USP_LOAD_ETL5_SUNGL_EXTRACT] @batch [NVARCHAR](100),@JOBNAMESTR [NVARCHAR](2000) AS
BEGIN 
...
BEGIN TRY
		...
		WHERE ENTITY_ID = 'IAI' AND SUBSTRING(CAST(@batch AS VARCHAR),1,4)+'/0'+SUBSTRING(CAST(@batch AS VARCHAR),5,2)+VALID_FROM = 
		...
		WHERE ENTITY_ID = 'IAI' AND TRIM(PERIOD) = SUBSTRING(CAST(@batch AS VARCHAR),1,4)+'/0'+SUBSTRING(CAST(@batch AS VARCHAR),5,2)
		) A GROUP BY PERIOD) A 
		)) A WHERE ACCNT_CODE IN (
		SELECT DISTINCT EXCL_FIELD2_COND FROM FOND_ID.FOND_ETL5_EXCLUSION_CONFIG 
		WHERE TRIM(EXCL_FLG) = 'EXCL' AND ENTITY_ID = 'IAI'
		...
		, VALID_FROM  
		FROM FOND_ID.FOND_ETL5_IFRS4_SUNGL 
		WHERE TRIM(PERIOD) = SUBSTRING(CAST(@batch AS VARCHAR),1,4)+'/0'+SUBSTRING(CAST(@batch AS VARCHAR),5,2) AND ENTITY_ID = 'IAI'
		) A GROUP BY PERIOD) A 
		)
		) A  
		WHERE
		...
		FROM FOND_ID.FOND_ETL5_EXCLUSION_CONFIG WHERE TRIM(EXCL_FLG) = 'INCL' AND ENTITY_ID = 'IAI'
		AND EXCL_FIELD1 = @acctcd_col AND (EXCL_FIELD2 = @jrnaltype_col)
		)) A INNER JOIN (
		SELECT EXCL_FIELD2_COND,ENTITY_ID FROM FOND_ID.FOND_ETL5_EXCLUSION_CONFIG WHERE TRIM(EXCL_FLG) = 'INCL' AND ENTITY_ID = 'IAI'
		AND EXCL_FIELD1 = @acctcd_col AND (EXCL_FIELD2 = @jrnaltype_col)
		...
		WHERE A.ACCNT_CODE+A.PERIOD+A.DESCRIPTN NOT IN (
				...
				FROM FOND_ID.FOND_ETL5_EXCLUSION_CONFIG WHERE TRIM(EXCL_FLG) = 'EXCL' AND ENTITY_ID = 'IAI'
		...
		SELECT EXCL_FIELD2_COND,EXCL_FIELD1_COND, ENTITY_ID FROM FOND_ID.FOND_ETL5_EXCLUSION_CONFIG WHERE TRIM(EXCL_FLG) = 'INCL' AND ENTITY_ID = 'IAI'
		AND EXCL_FIELD1 = @acctcd_col AND (EXCL_FIELD2 = @desc_col)
		...
		SELECT DISTINCT A.* FROM (
		SELECT * FROM #EXCL_FLAG WHERE ACCNT_CODE IN (
		SELECT EXCL_FIELD1_COND FROM FOND_ID.FOND_ETL5_EXCLUSION_CONFIG WHERE TRIM(EXCL_FLG) = 'INCL' AND ENTITY_ID = 'IAI'
		AND EXCL_FIELD1 = @acctcd_col AND (EXCL_FIELD2 = @jrnaltype_col AND EXCL_SUMMARY_DESC='IBNR')
		)) A INNER JOIN (
		SELECT EXCL_FIELD1_COND as EXCL_FIELD1_COND,EXCL_SUMMARY_DESC, ENTITY_ID FROM FOND_ID.FOND_ETL5_EXCLUSION_CONFIG WHERE TRIM(EXCL_FLG) = 'INCL' AND ENTITY_ID = 'IAI'
		AND EXCL_FIELD1 = @acctcd_col AND (EXCL_FIELD2 = @jrnaltype_col AND EXCL_SUMMARY_DESC='IBNR')
		...
		SELECT DISTINCT A.* FROM (
		SELECT * FROM #EXCL_FLAG WHERE ACCNT_CODE IN (
		SELECT EXCL_FIELD2_COND FROM FOND_ID.FOND_ETL5_EXCLUSION_CONFIG WHERE TRIM(EXCL_FLG) = 'INCL' AND ENTITY_ID = 'IAI'
		...
		WHERE EXCL_FIELD1 = @acctcd_col AND EXCL_FIELD2 = @jrnaltype_col and BIN_FLG='INCL' AND ENTITY_ID = 'IAI')
		...
		WHERE EXCL_FIELD1 = @desc_col AND (EXCL_FIELD2 IS NULL or EXCL_FIELD2='') AND ENTITY_ID = 'IAI')
...
--		WHERE EXCL_FIELD2_COND IS NULL --AND EXCL_FIELD1_COND = '5119030000' 
		WHERE EXCL_FIELD1=@acctcd_col and (EXCL_FIELD2_COND IS NULL or EXCL_FIELD2_COND='') and BIN_FLG='EXCL' and ACTION='I' AND ENTITY_ID = 'IAI'
		)
		;
		...
		SELECT DISTINCT * 
				...
				WHERE EXCL_FIELD2_COND IS NOT NULL and EXCL_FIELD2=@desc_col AND ENTITY_ID = 'IAI' --AND EXCL_FIELD1_COND = '5119030000' 
				)) A
				...
				WHERE EXCL_FIELD2_COND IS NOT NULL  and EXCL_FIELD2=@desc_col AND ENTITY_ID = 'IAI') B ON UPPER(A.DESCRIPTN) LIKE  B.EXCL_FIELD2_COND   and A.ACCNT_CODE=B.EXCL_FIELD1_COND AND A.ENTITY_ID = B.ENTITY_ID)
			) A
				;	
		...
		SELECT DISTINCT * 
				...
				SELECT DISTINCT EXCL_FIELD1_COND as EXCL_FIELD1_COND
				FROM FOND_ID.FOND_ETL5_BIN_ACCOUNT_CONFIG
				WHERE EXCL_FIELD2_COND IS NOT NULL and EXCL_FIELD2=@jrnalsrc_col AND ENTITY_ID = 'IAI' --AND EXCL_FIELD1_COND = '5119030000' 
				)) A
				INNER JOIN (SELECT DISTINCT UPPER(EXCL_FIELD2_COND ) EXCL_FIELD2_COND,UPPER(EXCL_FIELD1_COND) EXCL_FIELD1_COND, ENTITY_ID FROM FOND_ID.FOND_ETL5_BIN_ACCOUNT_CONFIG
				WHERE EXCL_FIELD2_COND IS NOT NULL and EXCL_FIELD2=@jrnalsrc_col AND ENTITY_ID = 'IAI') B ON UPPER(A.JRNAL_SRCE) LIKE  B.EXCL_FIELD2_COND   and A.ACCNT_CODE=B.EXCL_FIELD1_COND AND A.ENTITY_ID = B.ENTITY_ID)
			) A
				;
		...
		SELECT DISTINCT * 
				...
				SELECT DISTINCT EXCL_FIELD1_COND as EXCL_FIELD1_COND
				FROM FOND_ID.FOND_ETL5_BIN_ACCOUNT_CONFIG
				WHERE EXCL_FIELD2_COND IS NOT NULL and EXCL_FIELD2=@t0_col AND ENTITY_ID = 'IAI'
				)) A
				INNER JOIN (SELECT DISTINCT UPPER(EXCL_FIELD2_COND ) EXCL_FIELD2_COND,UPPER(EXCL_FIELD1_COND) EXCL_FIELD1_COND, ENTITY_ID FROM FOND_ID.FOND_ETL5_BIN_ACCOUNT_CONFIG
				WHERE EXCL_FIELD2_COND IS NOT NULL and EXCL_FIELD2=@t0_col AND ENTITY_ID = 'IAI') B ON UPPER(A.ANAL_T0) LIKE  B.EXCL_FIELD2_COND   and A.ACCNT_CODE=B.EXCL_FIELD1_COND AND A.ENTITY_ID = B.ENTITY_ID)
			) A
				;	
		...
		SELECT DISTINCT EXCL_FIELD1_COND FROM FOND_ID.FOND_ETL5_EXCLUSION_CONFIG	
		WHERE TRIM(EXCL_FLG) = 'EXCL' AND EXCL_FIELD1 = @jrnaltype_col AND (EXCL_FIELD2 IS NULL or EXCL_FIELD2='') AND ENTITY_ID = 'IAI')
		;
		-- DROP TABLE #STEP12
		...
		(
		SELECT DISTINCT EXCL_FIELD1_COND, ENTITY_ID FROM FOND_ID.FOND_ETL5_EXCLUSION_CONFIG
		WHERE EXCL_FIELD1 = @tref_col AND (EXCL_FIELD2 IS NULL or EXCL_FIELD2='') AND ENTITY_ID = 'IAI')
		...
		(
		SELECT DISTINCT EXCL_FIELD1_COND, EXCL_FIELD2_COND, ENTITY_ID FROM FOND_ID.FOND_ETL5_BIN_ACCOUNT_CONFIG
		WHERE EXCL_FIELD1 = @acctcd_col AND EXCL_FIELD2 = @jrnaltype_col AND ENTITY_ID = 'IAI')
		B ON UPPER(A.ACCNT_CODE) LIKE  UPPER(TRIM(B.EXCL_FIELD1_COND)) and UPPER(A.JRNAL_TYPE) LIKE  UPPER(TRIM(B.EXCL_FIELD2_COND)) AND A.ENTITY_ID = B.ENTITY_ID
		)
		;
		...
		(
		SELECT DISTINCT EXCL_FIELD1_COND, ENTITY_ID FROM FOND_ID.FOND_ETL5_EXCLUSION_CONFIG
		WHERE TRIM(EXCL_FLG) = 'EXCL' AND EXCL_FIELD1 = @acctcd_col AND TRIM(COALESCE(EXCL_FIELD2, '')) = '' AND ENTITY_ID = 'IAI') 
		...
		WHERE TRIM(EXCL_FLG) = 'EXCL' and EXCL_FIELD1 = @desc_col AND EXCL_FIELD2=@tref_col AND ENTITY_ID = 'IAI')
		...
		(
		SELECT DISTINCT EXCL_FIELD1_COND, EXCL_FIELD2_COND, ENTITY_ID FROM FOND_ID.FOND_ETL5_BIN_ACCOUNT_CONFIG
		WHERE EXCL_FIELD1 = @acctcd_col AND EXCL_FIELD2 = @tref_col AND ENTITY_ID = 'IAI')
		...
		INNER JOIN (
		SELECT DISTINCT EXCL_FIELD1_COND,EXCL_FIELD2_COND, ENTITY_ID FROM FOND_ID.FOND_ETL5_EXCLUSION_CONFIG 
		WHERE TRIM(EXCL_FLG) = 'EXCL' and EXCL_FIELD1 = @jrnaltype_col AND EXCL_FIELD2=@desc_col AND ENTITY_ID = 'IAI') B 
		...
		(
		SELECT DISTINCT EXCL_FIELD1_COND, ENTITY_ID FROM FOND_ID.FOND_ETL5_BIN_ACCOUNT_CONFIG
		WHERE EXCL_FIELD1 = @jrnalsrc_col AND (EXCL_FIELD2 IS NULL or EXCL_FIELD2='') AND ENTITY_ID = 'IAI')
		...
		(
		SELECT DISTINCT EXCL_FIELD1_COND,EXCL_FIELD2_COND, ENTITY_ID FROM FOND_ID.FOND_ETL5_EXCLUSION_CONFIG 
		WHERE TRIM(EXCL_FLG) = 'EXCL' and EXCL_FIELD1 = @tref_col AND EXCL_FIELD2= @desc_col AND ENTITY_ID = 'IAI')
		...
		(
		SELECT DISTINCT EXCL_FIELD1_COND, EXCL_FIELD2_COND, ENTITY_ID FROM FOND_ID.FOND_ETL5_BIN_ACCOUNT_CONFIG
		WHERE EXCL_FIELD1 = @tref_col AND EXCL_FIELD2 = @desc_col AND ENTITY_ID = 'IAI')
		B ON UPPER(A.TREFERENCE) LIKE  UPPER(TRIM(B.EXCL_FIELD1_COND)) and UPPER(A.DESCRIPTN) LIKE  UPPER(TRIM(B.EXCL_FIELD2_COND)) AND A.ENTITY_ID = B.ENTITY_ID
		)
		;
...
--SET @batch = '20201201';			
		...
		WHERE EXTRACT_PERIOD =  SUBSTRING(CAST(@batch AS VARCHAR),1,4)+'/0'+SUBSTRING(CAST(@batch AS VARCHAR),5,2) AND ENTITY_ID = 'IAI';
