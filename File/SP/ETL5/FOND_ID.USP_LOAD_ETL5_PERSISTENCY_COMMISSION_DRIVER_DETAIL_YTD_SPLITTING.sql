CREATE PROC [FOND_ID].[USP_LOAD_ETL5_PERSISTENCY_COMMISSION_DRIVER_DETAIL_YTD_SPLITTING] @batch [NVARCHAR](100),@JOBNAMESTR [NVARCHAR](2000) AS
BEGIN 
	--DECLARE @batch [nvarchar](30);
	DECLARE @V_START		datetime;
	DECLARE @V_END			datetime;
	DECLARE @V_FUNCTION_NAME	NVARCHAR(2000) = 'FOND_ID.USP_LOAD_ETL5_PERSISTENCY_COMMISSION_DRIVER_DETAIL_YTD_SPLITTING';
