CREATE PROC [FOND_ID].[USP_LOAD_ETL5_NEW_ENTRIES_SPLITTING] @batch [nvarchar](30) AS

BEGIN 
	DECLARE @V_START		datetime;
	DECLARE @V_END			datetime;
	DECLARE @V_FUNCTION_NAME	NVARCHAR(2000) = 'USP_LOAD_ETL5_NEW_ENTRIES_SPLITTING';
...
--	if (left(@batch,4)='2022')		
	...
	IF @CNT_CURR >= 1 AND @SUM_CURR <> 0
		WITH RI_CAT as (
		select 
		CASE WHEN ANAL_T7 IN ('PSY','TBR','DTB') THEN 'IAS' WHEN ANAL_T7 IN ('P01') THEN 'IAC' END ENTITY_ID
